                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-6 py-4 bg-white/5 border border-white/10 text-white placeholder-white/30 focus:outline-none focus:border-emerald-400 transition-colors uppercase"
                        />
                      </div>
                      ...
                      <button
                        ...
                        className="w-full px-8 py-4 bg-emerald-500 hover:bg-emerald-600 disabled:bg-emerald-500/50 text-white transition-all duration-300 text-sm uppercase tracking-wider flex items-center justify-center gap-3"
                      >
                        {isProcessing ? (
                          <>
                            <motion.div
